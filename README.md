...
- Build and manage Kubernetes platforms (AWS EKS, Azure AKS)
- Automate infrastructure using Terraform, Helm, and Ansible
- Improve reliability, security, and observability of production systems
...
**Security:** Vault, Trivy, GitHub Advanced Security  
